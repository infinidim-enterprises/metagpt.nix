#+html: <a href="https://github.com/infinidim-enterprises/metagpt.nix/actions/workflows/build-packages.yaml"><img src="https://img.shields.io/github/actions/workflow/status/infinidim-enterprises/metagpt.nix/build-packages.yaml?logo=nixos&logoColor=white&label=build"/></a>&nbsp;
