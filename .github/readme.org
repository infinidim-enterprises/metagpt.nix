#+html: <a href="https://github.com/infinidim-enterprises/metagpt.nix/actions/workflows/update-and-build.yaml"><img src="https://img.shields.io/github/actions/workflow/status/infinidim-enterprises/metagpt.nix/update-and-build.yaml?event=push&logo=nixos&logoColor=white&label=build"/></a>&nbsp;
